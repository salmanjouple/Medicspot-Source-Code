...
<div id="settings-page" class="container-fluid">
    <ul class="nav nav-tabs">
        <?php if ($privileges[PRIV_SYSTEM_SETTINGS]['view'] == TRUE): ?>
            <li role="representation" class="business-logic-tab tab <?php if($clinic_id!=FALSE){?>active<?php } ?>"><a><?php echo $this->lang->line('business_logic'); ?></a></li>
        <?php endif ?>
    ...
    <div id="business-logic" class="tab-content <?php echo $hidden; ?>" <?php if($clinic_id!=FALSE){?>style="display:block;"<?php } ?>>
        <form>
            ...
            <fieldset>
                ...
                <h4><?php echo $this->lang->line('clinics'); ?></h4>
                <select class="form-control" name="clinic_id" id="clinic_id">
                <option value="">Please Select</option>
                <?php 
                foreach($clinics as $c){
                    ?>
                    <option value="<?php echo $c['id'];?>" <?php if($clinic_id==$c['id']){?>selected="selected"<?php } ?>><?php echo $c['cl_clinic_name'];?> - <?php echo $c['pharmacy_name'];?></option>
                    <?php
                }
                ?>
                </select>
    ...
    ?>
    <?php $hidden = ($privileges[PRIV_SYSTEM_SETTINGS]['view'] == TRUE) ? '' : 'hidden'; ?>
    <div id="general" class="tab-content <?php echo $hidden; ?>" <?php if($clinic_id!=FALSE){?>style="display:none;"<?php } ?>>
    ...
    <div id="user" class="tab-content <?php echo $hidden; ?>" <?php if($clinic_id!=FALSE){?>style="display:none;"<?php } ?>>
        <form class="row">
...
<script language="javascript">
    $( document ).ready(function() {
        $('#clinic_id').on('change', function(){
            if($(this).val()!=''){
                window.location = '<?php echo base_url()?>backend/settings/'+$(this).val();
            }
        });
    });
</script>