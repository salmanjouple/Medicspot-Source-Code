...
class Searches_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $filters = array('search'); // filters to apply to when searching for items
	public $required = array('search'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('search'); // table name
	}
}

class Searche_model extends Base_module_record {
