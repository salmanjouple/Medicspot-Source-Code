...
class Teams_model extends Base_module_model {
	...
	public $required = array('name', 'bio'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	public $foreign_keys  = array('category_id' => array(FUEL_FOLDER => 'fuel_categories_model', 'where' => array('context' => 'team'))); // map foreign keys to table models
	...
	{
		parent::__construct('teams'); // table name
	}
}
