...
class Testimonials_model extends Base_module_model {
	...
	public $required = array('name','desc'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('testimonials'); // table name
	}
}

class Testimonial_model extends Base_module_record {
