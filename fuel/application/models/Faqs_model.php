...
class Faqs_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $filters = array('question'); // filters to apply to when searching for items
	public $required = array('question', 'answer'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('faqs'); // table name
	}
}

class Faq_model extends Base_module_record {
